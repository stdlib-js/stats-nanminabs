...
interface Unary {
	...
	*/
	...
	/**
	* Computes the minimum absolute value along one or more ndarray dimensions, ignoring `NaN` values, and assigns results to a provided output ndarray.
	*
	* @param x - input ndarray
